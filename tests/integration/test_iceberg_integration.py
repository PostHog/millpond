...
class TestIcebergIntegration:
    def test_write_round_trips_through_real_catalog_and_s3(self, stack):
        ...
        iceberg.write(catalog, "millpond", table_name, batch)
    ...
    def test_multiple_writes_accumulate(self, stack):
        catalog_uri, minio_endpoint = stack
        catalog = _connect(catalog_uri, minio_endpoint)
    ...
    def test_partition_layout_is_hive_style(self, stack):
