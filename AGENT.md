...
| `duckdb==1.5.5` | DuckDB Python client (pinned; image overwrites with PostHog/duckdb `v1.5.5-posthog.5` for VARIANT shred allowlist). DuckLake extension SHA canary in `tests/unit/test_ducklake_pin.py`. |
